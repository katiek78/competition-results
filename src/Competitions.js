    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                if (fetchedData) {
                    const isAdmin = () => (fetchedData.role === 'superAdmin' || fetchedData.role === 'admin');
                    ...
                    {competitions
                        ...
                        .map((competition) => (
                            <tr key={competition._id}>
                                ...
                                <td><FontAwesomeIcon title="Delete Competition" className="actionIcon" icon={faTrash} onClick={() => handleDeleteComp(competition._id)} /></td>
                            </tr>
                        ))
                    }
                </tbody>
